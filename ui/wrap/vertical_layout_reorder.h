...
class VerticalLayoutReorder final {
 public:
  ...
  VerticalLayoutReorder(not_null<VerticalLayout *> layout, not_null<ScrollArea *> scroll);
 ...
 private:
  ...
  void mousePress(not_null<RpWidget *> widget, Qt::MouseButton button, QPoint position);
