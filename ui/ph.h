...
struct phrase {
  ...
  phrase(const char (&initial)[Size]) : phrase(QString::fromUtf8(initial, Size - 1)) {
  }
...
template <int Count>
using phrase_value_array = std::array<std::pair<not_null<phrase *>, rpl::producer<QString>>, Count>;
